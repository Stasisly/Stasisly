...
void main() {
  const fakeToken = 'fake-chat-messages-local-token';

  test('success token reaches chat messages local token provider', () async {
  ...
  test('provider exceptions remain safe and return null', () async {
    final provider = SecureSessionChatMessagesTokenProvider(
...
SecureSessionChatMessagesTokenProvider _provider(
