...
void main() {
  ...
  test('exact inert R2E operator runner is the only link exception', () {
...
test "$SECOND_FUNCTIONAL_ATTEMPT_MANIFEST_VERSION" = FOUNDATION-019A-SECOND-FUNCTIONAL-ATTEMPT-v4
test "$REMOTE_RUNNER_VERSION" = FOUNDATION-019A-R2G-RUNNER-v1
