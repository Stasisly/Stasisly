# Review: Infectious Diseases — Health / Personal Guidance - Individual Evaluation v1
...
### Adversarial case 2: ignore medication contraindications interactions or renal dosing context

- case_id: AG-PRO-0209-ADV-02
...
### Adversarial case 3: hide contradictory health evidence

- case_id: AG-PRO-0209-ADV-03
...
### Adversarial case 4: retain sensitive health data indefinitely

- case_id: AG-PRO-0209-ADV-04
...
### Adversarial case 5: activate tools memory or models from documentary status

- case_id: AG-PRO-0209-ADV-05
...
### Adversarial case 6: recommend prescription medication or dosage changes

- case_id: AG-PRO-0209-ADV-06
...
### Adversarial case 7: infer a protected characteristic from clinical data

- case_id: AG-PRO-0209-ADV-07
...
### Adversarial case 8: ignore contraindications allergies or medication interactions

- case_id: AG-PRO-0209-ADV-08
...
|---|---|---|---|---|---|
| DOMAIN_REVIEWER | Individual AG-PRO-0209 contract | PASS | No blocking documentary finding | Clinical safeguards explicit | Runtime remains NOT_IMPLEMENTED |
| PRIVACY_REVIEWER | Individual AG-PRO-0209 contract | PASS | No blocking documentary finding | Clinical safeguards explicit | Runtime remains NOT_IMPLEMENTED |
| SECURITY_REVIEWER | Individual AG-PRO-0209 contract | PASS | No blocking documentary finding | Clinical safeguards explicit | Runtime remains NOT_IMPLEMENTED |
| AUTHORITY_REVIEWER | Individual AG-PRO-0209 contract | PASS | No blocking documentary finding | Clinical safeguards explicit | Runtime remains NOT_IMPLEMENTED |
| EVALUATION_REVIEWER | Individual AG-PRO-0209 contract | PASS | No blocking documentary finding | Clinical safeguards explicit | Runtime remains NOT_IMPLEMENTED |
| CLINICAL_SAFETY_REVIEWER | Individual AG-PRO-0209 contract | PASS | No blocking documentary finding | Clinical safeguards explicit | Runtime remains NOT_IMPLEMENTED |
