...
| `implementation/FOUNDATION-018_DEVELOPMENT_ENVIRONMENT_AND_CONTROLLED_REMOTE_PREPARATION.md` | ACTIVE / PREPARATION_IMPLEMENTED_LOCALLY | 6 | Architecture + Security + Release + Documentation | Evidence owner | No, local preparation evidence | Uncontrolled Development remote preparation | ADR-F021; FOUNDATION-017/019B | Development configuration, manifest, target, authorization or execution change |
| `adr/ADR-F021-development-environment-and-controlled-remote-preparation.md` | APPROVED / PREPARATION_IMPLEMENTED_LOCALLY | 2 | Architecture + Security under Rector | Founder | Yes | Implicit Development selection and ungoverned remote execution | ADR-F002/F004/F007/F020/F022 | Environment, secret ownership, deployment or remote authorization semantics change |
| `development/development_deployment_manifest.json` | ACTIVE / UNAPPROVED | 6 | Release Engineering + Security | Evidence owner; Founder for approval | No, machine-readable preparation | Informal deployment inventory | ADR-F021; FOUNDATION-018 | Any target, commit, approval, deployment or inventory state change |
