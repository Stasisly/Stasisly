...
SUPABASE_CLI_REMOTE_CONTEXT: ISOLATED
ACCIDENTAL_REMOTE_TARGETING: BLOCKED_LOCALLY
FOUNDATION-018: READY_TO_RETRY
Remote and G8-G10: NOT_AUTHORIZED
```

## FOUNDATION-017 package state

```text
FOUNDATION-017: IMPLEMENTED_LOCALLY
SAFE_OBSERVABILITY_FIELDS: FOUNDATION_ADOPTED
ACCESSIBILITY_AUDITED_LOCALLY: PASS (0 critical / 0 high open)
FOUNDATION-018: PROPOSED / REQUIRES_SEPARATE_APPROVAL
Remote and G8-G10: NOT_AUTHORIZED
```

## FOUNDATION-016-R1 package state

```text
FOUNDATION-016: IMPLEMENTED_LOCALLY via FOUNDATION-016-R1
LEGACY_CHAT_REFERENCE_ERADICATION: PASS
L0-L7: COMPLETE
FOUNDATION-017: PROPOSED / REQUIRES_SEPARATE_APPROVAL
Remote and G8-G10: NOT_AUTHORIZED
```
...
Package status after FOUNDATION-013F:
...
FOUNDATION-013F: IMPLEMENTED LOCALLY / PUBLICATION COMPLETES G7
...
| 013F | Canonical Conversation application layer and inactive Product composition - IMPLEMENTED LOCALLY | No Product route registration, active shell, legacy migration or staging/production activation |
