...
Map<String, Object?> _historicalEntry({
  ...
  return _entry(
    ...
    notes: '${agent.action}; historical source $historicalSourceCommit.',
  );
}
...
Map<String, Object?> _generatedEntry({
  ...
  return _entry(
    ...
    notes: 'Generated deterministically from catalog specification v1.',
  );
}
...
List<String> validateAgentCatalog(
  ...
  for (final entry in entries) {
    ...
    final wave1Coordinator = approvedWave1CoordinatorIds.contains(id);
    final expectedImplementation = wave1Coordinator
        ? 'DOCUMENTED_ONLY'
        : 'NOT_IMPLEMENTED';
    ...
    if (wave1Coordinator &&
      ...
      findings.add('WAVE_1_PROMPT_STATE_INVALID');
    }
  }
