...
Map<String, Object?> _historicalEntry({
  ...
  final wave2Approved = approvedWave2GovernanceIds.contains(agentId);
  return _entry(
    agentId: agentId,
    canonicalName: canonical,
    ...
    promptStatus: 'PROMPT_CREATED',
    lifecycleStatus: 'PROMPT_CREATED',
    implementationStatus: wave2Approved ? 'DOCUMENTED_ONLY' : 'NOT_IMPLEMENTED',
    historicalMapping:
        'docs/archive/discovery/stasisly_definition/agents/${agent.file}',
    notes: wave2Approved
        ? '${agent.action}; Wave 2 canonical documentary prompt approved; '
...
Map<String, Object?> _generatedEntry({
  ...
  return _entry(
    ...
    promptStatus: wave2Approved ? 'PROMPT_CREATED' : 'NOT_CREATED',
    lifecycleStatus: wave2Approved ? 'PROMPT_CREATED' : 'CATALOGED',
    implementationStatus: wave2Approved ? 'DOCUMENTED_ONLY' : 'NOT_IMPLEMENTED',
    notes: wave2Approved
        ? 'Wave 2 canonical documentary prompt approved; runtime, authority, '
