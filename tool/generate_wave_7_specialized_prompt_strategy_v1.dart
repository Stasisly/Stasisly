...
Wave 7 scope by surface: `${jsonEncode(surfaceCounts)}`. Domains: `${remaining.map((e) => '${e['surface']}|${e['domain']}').toSet().length}`. Families: `${families.length}`. W7-001 through W7-010 have 514 approved documentary prompts; the remaining 2,264 records stay NOT_STARTED. Runtime coverage remains absent.
'''
            .trimLeft(),
...
W7-003 specialized prompts / evaluations created: 45 / 45
W7-003 prompt, lifecycle and implementation transitions: 45
W7-003 P0-P14: 675 PASS; P15-P17: NOT_EXECUTED
W7-004 specialized prompts / evaluations created: 22 / 22
W7-004 prompt, lifecycle and implementation transitions: 22
W7-004 P0-P14: 330 PASS; P15-P17: NOT_EXECUTED
W7-005 specialized prompts / evaluations created: 10 / 10
W7-005 prompt, lifecycle and implementation transitions: 10
W7-005 P0-P14: 150 PASS; P15-P17: NOT_EXECUTED
W7-006 specialized prompts / evaluations created: 7 / 7
W7-006 prompt, lifecycle and implementation transitions: 7
W7-006 P0-P14: 105 PASS; P15-P17: NOT_EXECUTED
W7-007 specialized prompts / evaluations created: 100 / 100
W7-007 prompt, lifecycle and implementation transitions: 100
W7-007 P0-P14: 1500 PASS; P15-P17: NOT_EXECUTED
...
W7-010 specialized prompts / evaluations created: 90 / 90
W7-010 prompt, lifecycle and implementation transitions: 90
W7-010 P0-P14: 1350 PASS; P15-P17: NOT_EXECUTED
Remaining Wave 7 agents: 2264 NOT_STARTED
