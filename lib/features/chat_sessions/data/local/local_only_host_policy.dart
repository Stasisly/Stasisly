...
abstract interface class OwnChatSessionsHostPolicy {
  bool allows(Uri baseUri);
}

class LocalOnlyHostPolicy implements OwnChatSessionsHostPolicy {
...
class DevelopmentRemoteHostPolicy implements OwnChatSessionsHostPolicy {
